    ...
    return (
      <div className="employee-empty card">
        <div className="card-body">
          ...
          <button type="button" className="btn btn-primary" onClick={() => navigate('/store-dashboard/employees')}>
            Back to Employees
          </button>
        </div>
      </div>
  ...
  return (
    <div className="employee-detail-page">
      <div className="content-header employee-page-header">
        <div>
          <button type="button" className="employee-back-link" onClick={() => navigate('/store-dashboard/employees')}>
            <ArrowLeft size={16} />
            Back to employees
          </button>
