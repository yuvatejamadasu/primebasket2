    ...
    if (!brand) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] animate-fade-in">
                ...
                <button 
                    onClick={() => navigate('/store-dashboard/brands')}
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <nav className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest mb-2">
                        <button onClick={() => navigate('/store-dashboard/brands')} className="text-slate-400 hover:text-brand transition-colors">Brands</button>
