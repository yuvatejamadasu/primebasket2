...
import {
  DollarSign, Truck, Package, ShoppingCart, PlusSquare, Plus,
  RefreshCw, Loader2, TrendingUp, Users, Zap, ShoppingBag, LayoutGrid
} from 'lucide-react';
import {
...
import { fetchSalesData, fetchRevenueData, API_ENDPOINTS } from '../services/fakeApi';
...
const Dashboard = () => {
  ...
  const [members, setMembers] = useState([
    { id: 1, name: 'Patric Adams', city: 'San Francisco', avatar: 'https://i.pravatar.cc/150?u=patric' },
    { id: 2, name: 'Dilan Specter', city: 'San Francisco', avatar: 'https://i.pravatar.cc/150?u=dilan' },
    { id: 3, name: 'Tomas Baker', city: 'San Francisco', avatar: 'https://i.pravatar.cc/150?u=tomas' },
  ]);

  const handleAddMember = () => {
    setMembers([{ id: Date.now(), name: 'New Member', city: 'San Francisco', avatar: `https://i.pravatar.cc/150?u=${Date.now()}` }, ...members]);
  };
